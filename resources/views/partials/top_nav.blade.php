    ...
    <ul class="flex justify-center gap-8">
        ...
        <li class="hover:bg-[#262626] p-2 text-center">
            <a href="{{route('graveyard.index')}}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="w-20 h-20 text-red-800 mx-auto font-bold">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <li class="hover:bg-[#262626] p-2 text-center">
            <a href="{{ route('cards') . '?categories[0]=3'}}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="w-20 h-20 text-center mx-auto">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <li class="hover:bg-[#262626] p-2 text-center">
            <a href="{{ route('pages.show', ['slug' => \config('other.rules_slug_name')]) }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="w-20 h-20 mx-auto text-[#b69255]">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <li class="hover:bg-[#262626] p-2 text-center" title="{{ __('torrent.leeching') }}">
            <a href="{{ route('user_torrents', ['username' => auth()->user()->username, 'unsatisfied' => 'include']) }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="w-20 h-20 text-red-800 mx-auto">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <li class="hover:bg-[#262626] p-2 text-center">
            <a href="{{ route('pages.show', ['slug' => \config('other.donation_slug_name')]) }}">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-20 h-20 mx-auto text-red-500 outline-2
                 outline-black">
