                    ...
                    <form role="form" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="language" name="language">
                                    @foreach (App\Models\Language::allowed() as $code => $name)
                                        <option @if (auth()->user()->locale == $code) selected @endif
                        ...
                        <div class="well">
                            ...
                            <div class="radio-inline">
                                <label><input type="radio" name="censor" @if ($user->censor == 1) checked @endif
                            ...
                            <div class="radio-inline">
                                <label><input type="radio" name="chat_hidden"
                                        @if ($user->chat_hidden == 1) checked @endif
                                        value="1">{{ __('common.yes') }}</label>
                            </div>
                            <div class="radio-inline">
                                <label><input type="radio" name="chat_hidden"
                                        @if ($user->chat_hidden == 0) checked @endif
                                        value="0">{{ __('common.no') }}</label>
                            </div>
                        </div>
                        ...
                        <div class="well">
                            ...
                            <select class="form-control" id="torrent_layout" name="torrent_layout">
                                <option @if ($user->torrent_layout == 0) selected @endif value="0">Torrent List
                                </option>
                            </select>
                            <br>
                            <label for="poster" class="control-label">Show Posters On Torrent List View?</label>
                            <div class="radio-inline">
                                <label><input type="radio" name="show_poster"
                                        @if ($user->show_poster == 1) checked @endif
                                        value="1">{{ __('common.yes') }}</label>
                            </div>
                            <div class="radio-inline">
                                <label><input type="radio" name="show_poster"
                                        @if ($user->show_poster == 0) checked @endif
                                        value="0">{{ __('common.no') }}</label>
                            </div>
                            <br>
                            <br>
                            ...
                            <div class="radio-inline">
                                <label><input type="radio" name="ratings"
                                        @if ($user->ratings == 1) checked @endif value="1">IMDB</label>
                            </div>
                            <div class="radio-inline">
                                <label><input type="radio" name="ratings"
                                        @if ($user->ratings == 0) checked @endif value="0">TMDB</label>
                            </div>
                        </div>
