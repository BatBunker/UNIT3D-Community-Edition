...
use function {sprintf, cache};

class TorrentObserver
{
    private const CACHE_KEY = 'torrent:%s';
    ...
    {
        cache()->put(sprintf(self::CACHE_KEY, $torrent->info_hash), $torrent);
    }
    ...
    {
        cache()->forget(sprintf(self::CACHE_KEY, $torrent->info_hash));
        cache()->put(sprintf(self::CACHE_KEY, $torrent->info_hash), $torrent);
    }
